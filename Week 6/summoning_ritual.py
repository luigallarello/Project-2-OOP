...
class SummoningRitual:
    ...
    def get_undead_class(self):
        return self.__undead_class

    undead_class = property(get_undead_class)
    ...
    def create_undead(self, unit_id):
        try:
            return self.undead_class(unit_id, self.undead_name, self.starting_health, self.starting_power)
        except TypeError:
            return self.undead_class(unit_id)
